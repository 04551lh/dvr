...
import com.adasplus.settings.adapter.ResolutionRatioAdapter;
import com.adasplus.settings.adapter.VideoChannelsSetAdapter;
...
import com.adasplus.settings.mvp.contract.OnResolutionRatioListener;
        ...
        if (id == R.id.iv_back) {
            ...
            if (mVideoSetModel != null) {
                ...
                try {
                    ...
                    SettingsWrapper.getInstance().updateVideoSet(jobj).subscribe(new Subscriber<VideoSetModel>() {
                        @Override
