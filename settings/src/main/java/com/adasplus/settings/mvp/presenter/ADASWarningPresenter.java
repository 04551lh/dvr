...
import com.adasplus.settings.adapter.WarningsAdapter;
import com.adasplus.settings.mvp.contract.IADASWarningContract;
...
public class ADASWarningPresenter implements IADASWarningContract.Presenter, View.OnClickListener, ISwitchItemClickListener, SlideSwitchView.OnSwitchStatusChangeListener {
    ...
    private void getADASDefaultSet() {
        SettingsWrapper.getInstance().getADASSet().subscribe(new Subscriber<ADASWarningModel>() {
            @Override
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.iv_back) {
            ...
            //恢复 adas 报警默认设置
            SettingsWrapper.getInstance().adasRestoreDefaultSettings().subscribe(new Subscriber<WarningsRestoreDefaultSettingsModel>() {
                @Override
                public void onCompleted() {
            ...
            if (mAdasWarningModel != null) {
                ...
                try {
                    ...
                    SettingsWrapper.getInstance().updateADASSet(jsonObject).subscribe(new Subscriber<ADASWarningModel>() {
                        @Override
                        public void onCompleted() {
