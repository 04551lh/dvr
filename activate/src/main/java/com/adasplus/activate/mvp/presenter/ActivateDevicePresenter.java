...
import com.adasplus.activate.activity.AddNewPlatformsActivity;
import com.adasplus.activate.adapter.ActivatedPlatformsAdapter;
import com.adasplus.activate.mvp.contract.IActivateDeviceContract;
...
public class ActivateDevicePresenter implements IActivateDeviceContract.Presenter, View.OnClickListener {
    ...
    public void initData() {
        ...
        // 获取已经连接的部标平台
        ActivateWrapper.getInstance().getPlatformInfoModel().subscribe(new Subscriber<GetPlatformInfoModel>() {
            @Override
            public void onCompleted() {
