...
public class NetworkSetPresenter implements INetworkSetContract.Presenter, View.OnClickListener {
    ...
    public void initData() {
        ...
        HomeWrapper.getInstance().getDeviceValueByNetworkRequest().subscribe(new Subscriber<NetworkSetModel>() {
            @Override
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.iv_back){
            ...
            //保存更改最新的网络设置数据
            HomeWrapper.getInstance().updateNetworkSet(jsonObject).subscribe(new Subscriber<NetworkSetModel>() {
                @Override
                public void onCompleted() {
