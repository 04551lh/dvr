 ...
 * Description :
 */
public class VideoPreviewPresenter implements IFileExportContract.Presenter, View.OnClickListener, OnItemChannelNumbersClickListener, OnItemStreamTypeClickListener, SwipeRefreshLayout.OnRefreshListener {

    private IVideoPreviewContract.View mFileExportView;
...
//    private TextView mTvSelectDate;
    ...
    public VideoPreviewPresenter(Activity activity, IVideoPreviewContract.View view) {
