...
public class SignConfigBuilder {
    ...
    public SignConfigBuilder trackSize(Context context,int dp) {
        this.trackSize = DisplayUtils.dp2px(context,dp);
        return this;
    }

    public SignConfigBuilder secondTrackSize(Context context,int dp) {
        this.secondTrackSize = DisplayUtils.dp2px(context,dp);
        return this;
    }

    public SignConfigBuilder thumbRadius(Context context,int dp) {
        this.thumbRadius = DisplayUtils.dp2px(context,dp);
        return this;
    }

    public SignConfigBuilder thumbRadiusOnDragging(Context context,int dp) {
        this.thumbRadiusOnDragging = DisplayUtils.dp2px(context,dp);
        return this;
    }
    ...
    public SignConfigBuilder sectionTextSize(int sp, Context context) {
        this.sectionTextSize = DisplayUtils.sp2px(context,sp);
        return this;
    }
    ...
    public SignConfigBuilder thumbTextSize(Context context,int sp) {
        this.thumbTextSize = DisplayUtils.sp2px(context,sp);
        return this;
    }
    ...
    public SignConfigBuilder signTextSize(Context context,int sp) {
        this.signTextSize = DisplayUtils.sp2px(context,sp);
        return this;
    }
