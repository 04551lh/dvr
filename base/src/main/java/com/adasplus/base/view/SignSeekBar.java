...
import static com.adasplus.base.view.SignSeekBar.TextPosition.BELOW_SECTION_MARK;
import static com.adasplus.base.view.SignSeekBar.TextPosition.BOTTOM_SIDES;
import static com.adasplus.base.view.SignSeekBar.TextPosition.SIDES;
...
public class SignSeekBar extends View {
    ...
    public SignSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTrackSize = a.getDimensionPixelSize(R.styleable.SignSeekBar_ssb_track_size, DisplayUtils.dp2px(context,2));
        mTextSpace = a.getDimensionPixelSize(R.styleable.SignSeekBar_ssb_text_space, DisplayUtils.dp2px(context,2));
        mSecondTrackSize = a.getDimensionPixelSize(R.styleable.SignSeekBar_ssb_second_track_size, mTrackSize + DisplayUtils.dp2px(context,2));
        mThumbRadius = a.getDimensionPixelSize(R.styleable.SignSeekBar_ssb_thumb_radius, mSecondTrackSize + DisplayUtils.dp2px(context,2));
        mThumbRadiusOnDragging = a.getDimensionPixelSize(R.styleable.SignSeekBar_ssb_thumb_radius, mSecondTrackSize * 2);
        mSignBorderSize = a.getDimensionPixelSize(R.styleable.SignSeekBar_ssb_sign_border_size, DisplayUtils.dp2px(context,1));
        ...
        mSectionTextSize = a.getDimensionPixelSize(R.styleable.SignSeekBar_ssb_section_text_size, DisplayUtils.sp2px(context,14));
        ...
        mThumbTextSize = a.getDimensionPixelSize(R.styleable.SignSeekBar_ssb_thumb_text_size, DisplayUtils.sp2px(context,14));
        ...
        mSignTextSize = a.getDimensionPixelSize(R.styleable.SignSeekBar_ssb_sign_text_size, DisplayUtils.sp2px(context,14));
        mSignHeight = a.getDimensionPixelSize(R.styleable.SignSeekBar_ssb_sign_height, DisplayUtils.dp2px(context,32));
        mSignWidth = a.getDimensionPixelSize(R.styleable.SignSeekBar_ssb_sign_width, DisplayUtils.dp2px(context,72));
        mSignArrowHeight = a.getDimensionPixelSize(R.styleable.SignSeekBar_ssb_sign_arrow_height, DisplayUtils.dp2px(context,3));
        mSignArrowWidth = a.getDimensionPixelSize(R.styleable.SignSeekBar_ssb_sign_arrow_width, DisplayUtils.dp2px(context,5));
        mSignRound = a.getDimensionPixelSize(R.styleable.SignSeekBar_ssb_sign_round, DisplayUtils.dp2px(context,3));
    ...
    private void initConfigByPriority() {
        ...
        if (mSecondTrackSize < mTrackSize) {
            mSecondTrackSize = mTrackSize + DisplayUtils.dp2px(mContext,2);
        }
        if (mThumbRadius <= mSecondTrackSize) {
            mThumbRadius = mSecondTrackSize + DisplayUtils.dp2px(mContext,2);
        }
    ...
    private void drawMark(Canvas canvas, float xLeft, float yTop, boolean isShowTextBelowSectionMark, boolean conditionInterval) {
        float r = (mThumbRadiusOnDragging - DisplayUtils.dp2px(mContext,2)) / 2f;
